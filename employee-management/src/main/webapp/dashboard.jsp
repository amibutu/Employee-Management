...
<body>
	<h1 class="center" style="background-color:#666666;color:white">Employee Management</h1>
	<ul>
	...
	<table border="1"  class="center">
		<tr><td class="header-class">Employees</td></tr>
		<tr>
			<th>Employee ID</th>
			<th>First Name</th>
			<th>Last Name</th>
	...
	<table border="1"  class="center">
		<tr><td class="header-class">Departments</td></tr>
		<tr>
			<th>Department Id</th>
	...
	<table border="1"  class="center">
		<tr><td class="header-class">Compliance</td></tr>
		<tr>
			<th>Compliance Id</th>
	...
	<table border="1"  class="center">
		<tr><td class="header-class">Comments</td></tr>
		<tr>
			<th>Comment Id</th>
			<th>Comment</th>
			<th>Compliance Id</th>
