package com.java.project.emanagement.controller;
...
import com.java.project.emanagement.model.Compliance;
import com.java.project.emanagement.model.Department;
import com.java.project.emanagement.model.EmployeeBean;
import com.java.project.emanagement.model.StatusReport;
import com.java.project.emanagement.repository.ComplianceRepository;
import com.java.project.emanagement.repository.DepartmentRepository;
import com.java.project.emanagement.repository.EmployeeRepository;
import com.java.project.emanagement.repository.StatusReportRepository;
...
//				getCommentList(request, response);
	...
	public void getComplianceList(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException{
		...
		if(StringUtils.equalsIgnoreCase(user.getRole(), "ADMIN")) {
			compList = compRepo.getAllCompliance();
		}else {
			compList = compRepo.getAllComplianceForDept(user.getDepartmentId());
		}
	...
	public void getCommentList(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException{
		...
		EmployeeBean user = (EmployeeBean) request.getAttribute("user");
		if(StringUtils.equalsIgnoreCase(user.getRole(), "ADMIN")) {
			stsrptList = stsrtpRepo.getAllStatusReport();
		}else {
			stsrptList = stsrtpRepo.getAllStatusReportForUser(user.getId());
		}
